...
export class regionalStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps ) {
    ...
    console.log(fqdn, failoverdomain);

    // Create ACM SSL Certificate with DNS validation
    // SSL certificate must contains both regional & failover domain in the Subject Alternative Name
    // const cert = new acm.Certificate(this, 'cert', {
    //   domainName: fqdn,
    //   subjectAlternativeNames: [fqdn, failoverdomain],
